...
const Footer: React.FC = () => {
  return (
    <footer className="bg-black/80 backdrop-blur-3xl border-t border-white/5 pt-16 md:pt-24 pb-12 text-slate-400 relative z-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-24">
          <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8">
            <div className="flex items-center h-[24px] md:h-[30px]">
              <span className="text-[24px] md:text-[30px] font-medium font-sans lowercase leading-none flex items-center tracking-normal text-white">
                rapt
              </span>
            </div>
            <p className="text-base md:text-lg leading-relaxed max-w-md text-slate-500 font-light">
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] font-mono tracking-widest uppercase text-slate-600">
          ...
          <div className="flex items-center gap-8">
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                // We don't have a direct way to trigger the App's onNavigate from here without props,
                // but since it's a single page app with state-based routing, we can use window.location or just tell them the URL.
                // Actually, I'll just make it a real link that they can click if I update App.tsx to handle URL params or just use the state.
                // For now, I'll just make it a link to /admin and let the user know.
