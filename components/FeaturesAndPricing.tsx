  ...
  return (
    <section id="features" className="relative bg-transparent py-12 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
        <div className="space-y-24 md:space-y-40 py-12 lg:py-24">
          ...
          {features.map((feature, idx) => (
            ...
            >
              <div className="w-10 h-10 md:w-12 md:h-12 bg-white/5 rounded-xl md:rounded-2xl flex items-center justify-center mb-6 border border-white/10">
                {React.cloneElement(feature.icon as React.ReactElement, { className: "w-5 h-5 md:w-6 md:h-6 text-teal-400" })}
              </div>
              <h3 className="text-2xl md:text-3xl font-medium text-white mb-4">{feature.title}</h3>
...
export const CoreAdvantageSection: React.FC = () => {
    return (
        <section className="min-h-screen relative flex items-center justify-center py-12 md:py-24 overflow-hidden bg-transparent">
            <div className="text-center max-w-6xl mx-auto px-6 z-10">
                <h2 className="text-3xl md:text-4xl lg:text-5xl text-white mb-12 md:mb-16 font-light">
                    Every Transaction. Scrutinised. Automatically.
                </h2>
                <div className="relative mx-auto w-full max-w-5xl">
                    <div className="relative transform transition-all duration-700 hover:scale-[1.02]">
                        <div className="bg-[#0a0a0a] rounded-xl md:rounded-2xl p-2 md:p-4 border border-white/10 shadow-[0_0_100px_rgba(45,212,191,0.1)] relative z-20">
                            <div className="bg-[#050505] rounded-lg md:rounded-xl overflow-hidden relative border border-white/5 shadow-2xl">
                                <div className="h-10 md:h-12 bg-[#0f0f0f] flex items-center px-4 md:px-6 border-b border-white/10 justify-between">
                                    <div className="flex items-center gap-2 md:gap-4">
                                        <div className="flex gap-1 md:gap-1.5">
                                            <div className="w-2 md:w-2.5 h-2 md:h-2.5 rounded-full bg-red-500/40"></div>
                                            <div className="w-2 md:w-2.5 h-2 md:h-2.5 rounded-full bg-yellow-500/40"></div>
                                            <div className="w-2 md:w-2.5 h-2 md:h-2.5 rounded-full bg-green-500/40"></div>
                                        </div>
                                        <span className="text-[8px] md:text-[10px] text-teal-500 font-mono tracking-widest uppercase">Transaction_Review_Module</span>
                                    </div>
                                    <div className="text-[8px] md:text-[10px] text-slate-500 font-mono hidden sm:block">SCAN_ID: 0x8FA...42</div>
                                </div>
                                <div className="p-4 md:p-8 space-y-3 md:space-y-4 font-sans">
                                    {/* Row 1 */}
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 md:p-5 bg-white/[0.02] border border-white/5 rounded-lg md:rounded-xl hover:bg-white/[0.04] transition-all group gap-3">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-xs md:text-sm text-white font-medium">Related Party Transfer</span>
                                            <span className="text-[8px] md:text-[10px] text-slate-500 uppercase tracking-wider font-mono">Voucher #JV-0291</span>
                                        </div>
                                        <div className="flex items-center justify-between w-full sm:w-auto gap-4 md:gap-8">
                                            <span className="text-xs md:text-sm font-bold text-white">Rs. 8,00,000</span>
                                            <div className="flex items-center gap-2 px-2 md:px-3 py-0.5 md:py-1 bg-teal-500/10 border border-teal-500/30 rounded-full">
                                                <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-teal-500"></div>
                                                <span className="text-[8px] md:text-[10px] font-bold text-teal-400 uppercase tracking-wider">Matched</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 md:p-5 bg-white/[0.02] border border-white/5 rounded-lg md:rounded-xl hover:bg-white/[0.04] transition-all group gap-3">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-xs md:text-sm text-white font-medium">Advance to Supplier</span>
                                            <span className="text-[8px] md:text-[10px] text-slate-500 uppercase tracking-wider font-mono">Voucher #CP-1102</span>
                                        </div>
                                        <div className="flex items-center justify-between w-full sm:w-auto gap-4 md:gap-8">
                                            <span className="text-xs md:text-sm font-bold text-white">Rs. 12,50,000</span>
                                            <div className="flex items-center gap-2 px-2 md:px-3 py-0.5 md:py-1 bg-teal-500/10 border border-teal-500/30 rounded-full">
                                                <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-teal-500"></div>
                                                <span className="text-[8px] md:text-[10px] font-bold text-teal-400 uppercase tracking-wider">Matched</span>
                                            </div>
                                    ...
                                    {/* Row 3 - Warning */}
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 md:p-5 bg-red-500/5 border border-red-500/30 rounded-lg md:rounded-xl shadow-[0_0_30px_rgba(239,68,68,0.05)] animate-pulse-subtle gap-3">
                                        <div className="flex flex-col gap-1">
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs md:text-sm text-white font-medium">Round Figure Entry</span>
                                                <AlertTriangle className="w-3 md:w-3.5 h-3 md:h-3.5 text-red-500" />
                                            </div>
                                            <span className="text-[8px] md:text-[10px] text-red-200/60 font-mono">
                                                No narration — Period end posting
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between w-full sm:w-auto gap-4 md:gap-8">
                                            <span className="text-xs md:text-sm font-bold text-red-400">Rs. 5,00,000</span>
                                            <div className="flex items-center gap-2 md:gap-4">
                                                <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-0.5 md:py-1 bg-red-500/20 border border-red-500/40 rounded-full">
                                                    <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.8)]"></div>
                                                    <span className="text-[8px] md:text-[10px] font-bold text-red-500 uppercase tracking-wider">Warning</span>
                                                </div>
                                                <button className="bg-red-500 hover:bg-red-600 text-black text-[8px] md:text-[10px] font-black px-3 md:px-4 py-1.5 md:py-2 rounded-lg uppercase tracking-tight transition-all shadow-lg shadow-red-500/20">
                                                    Flag
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div className="h-8 md:h-10 bg-[#0f0f0f] border-t border-white/5 flex items-center px-4 md:px-6">
                                    <div className="flex items-center gap-2 text-[8px] md:text-[9px] text-slate-500 font-mono">
                                        <Activity className="w-2.5 md:w-3 h-2.5 md:h-3 text-teal-500" />
